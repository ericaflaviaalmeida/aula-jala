...
from dino_runner.utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, DEFAULT_TYPE, SCORE_SOUND,FUNDO,FUNDO_INIT,JUMP_SOUND,BUTTON
...
class Game:
    ...
    def draw_background(self):
        ...
        self.screen.blit(FUNDO, (self.x_pos_bg, self.y_pos_bg))
        self.screen.blit(FUNDO, (image_width + self.x_pos_bg, self.y_pos_bg)) 
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            self.screen.blit(BUTTON, (half_screen_width -200,half_screen_height-100))
        else:
